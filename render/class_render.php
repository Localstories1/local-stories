...
class render {
	...
	private static $TPL_EXT_DESC				= '.csv';
	private static $TPL_VAR_TAG 				= 'VAR:';
	private static $TPL_VAR_SUB 				= '#(\{[^\}]*\})#';
	private static $TPL_VAR_SEPARATOR_VAL 		= ';';
	private static $TPL_VAR_SEPARATOR_VAL_RPL 	= '--------------------------qfpj qsdfviopzjhfaqd51 3d0 d0azd----';
	private static $TPL_VAR_SEPARATOR_VAL_LIST 	= '|';
	...
	public function load_desc(){
		...
		foreach($tpl_vars as $k => $v){
			...
			$class 				= self::$VAR_PREFIX.strtolower($type);
